...
export default function Home() {
  return (
    <div className="overflow-hidden h-screen bg-gradient-to-b from-gradient-primary to-gradient-secondary font-sans">
      {/* Profile Image */}
      <div className="relative w-full h-70 overflow-auto px-5">
        <Image
      ...
      <div className="h-full bg-gradient-to-b from-gradient_1 to-gradient_2 px-5">
